...
<li>- 0703313371</li>
            <li>Email: contact@smartguesthouse237.cm</li>
            
            
            <li className="flex items-center gap-4 pt-2">
              <a href="https://www.facebook.com/smartguesthouse237" target="_blank" rel="noopener noreferrer" className="p-2 bg-blue-600 text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="Facebook">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://wa.me/237696983834" target="_blank" rel="noopener noreferrer" className="p-2 bg-green-500 text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="WhatsApp">
